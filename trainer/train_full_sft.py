...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="cbMind Full SFT")
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="cbMind-Full-SFT", help="wandb项目名"
    )
    parser.add_argument(
        "--use_compile",
        default=0,
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"cbMind-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
