...
def init_model(
    ...
    tokenizer = AutoTokenizer.from_pretrained(tokenizer_path)  # AutoTokenizer 会自动处理 tokenizer_path 中的配置文件，加载正确的 tokenizer 类和权重

    model = cbMindForCausalLM(lm_config)
